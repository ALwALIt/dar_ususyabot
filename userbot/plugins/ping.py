...
async def _(event):
    ...
    if flag == " -a":
        ...
        await catevent.edit(f"متوسط البنع !\n`{ms} ms`")
    else:
        catevent = await edit_or_reply(event, "بونغ!")
        end = datetime.now()
        ms = (end - start).microseconds / 1000
        await catevent.edit(f"بونغ!\n`{ms} ms`")
...
async def _(event):
    ...
    event = await edit_or_reply(event, "البنغ....")
    animation_chars = [
        "⬛⬛⬛⬛⬛⬛⬛⬛⬛",
        "⬛⬛⬛⬛⬛⬛⬛⬛⬛ \n⬛‎📶‎📶‎📶‎📶‎📶‎📶‎📶⬛",
        "⬛⬛⬛⬛⬛⬛⬛⬛⬛ \n⬛‎📶‎📶‎📶‎📶‎📶‎📶‎📶⬛ \n⬛⬛⬛⬛‎📶⬛⬛‎📶⬛",
