...
@jmthon.ar_cmd(
    pattern="كشف المستخدم(?:\s|$)([\s\S]*)",
    command="كشف المستخدم", plugin_category),
    info={
...
@jmthon.ar_cmd(
    pattern="ايدي|ا(?:\s|$)([\s\S]*)",
    command=("ايدي|ا", plugin_category),
    info={
...
#تعديل وترتيب  @SBB_B
@jmthon.ar_cmd(
    pattern="رابط المستخدم(?:\s|$)([\s\S]*)",
    command=("رابط المستخدم", plugin_category),
    info={
