...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**⌔︙ دارو مطورين السورس ميزاجور لجمثون**\n⌔︙ **التـغييرات\n** {changelog}"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "** ⌔︙ تم ميزاجور سورس جمثون بنجاح تسنا شوية و انقولولك مور اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, "**⌔︙ يـتـم البـحـث عـن ميـزاجـورات سـورس جـمـثـون تسـنا**")
    ...
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"⌔ :  باش دير ميزاجور لـ سورس جمثون صيفط : `.تحديث الان` "
        )
    ...
    if conf == "الان":
        await event.edit("** ⌔︙ جار مـيـزاجـور سـورس جـمثـون تسـنا شويـة 🔨**")
