...
async def amireallyalive(event):
    ...
    CUSTOM_ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "⇝ 𝗪َ𝗘𝗟َِ𝗖𝗢𝗠َِ𝙀َِ 𝗧𝗢 𝗝𝗠𝗧𝗛𝗢𝗡 𝄵 ⇜"
    CAT_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/e04ff21ae3ced22fe21cb.jpg"
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} قاعدۿ البيانات:** `تعمل بنجاح` \n"
        cat_caption += f"**{EMOJI} المنشئ:** {mention}\n"
        cat_caption += f"**{EMOJI} الوقت :** `{uptime}`\n"
        cat_caption += f"**{EMOJI} قـناة السـورس** : [𝗝ََِ𝗠ٓ𝗧َُِْٓ𝗛ُ𝗢َ𝗡ٍَ](t.me/JMTHON) \n" 
