# image search for catuserbot  - EDIT  : @JMTHON
import os
import shutil
...
async def img_sampler(event):
    ...
    if not query:
        return await edit_or_reply(
            event, "يجب الرد على الرسالة او وضع كلام يتم البحث عنه"
        )
    cat = await edit_or_reply(event, "@JMTHON")
